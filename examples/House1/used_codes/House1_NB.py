...
plot.render(outfile="house_NB_detail.png")
...
plot.render(outfile="House1_NB_results.png")
solph_representation.build_solph_model()

output = pd.DataFrame(flows)
#saving flows in csv file
output.to_csv(os.path.join("flows_nobattery", "flow_NB_nov23.csv"), index=True)