...
def calculate_monthly_co2_emissions(scenario_identifier, scenario_config):
    ...
    ALL_FLOWS = {
        ...
        "Total_PV2_Production": [
            ("SolphLabel(location='House1', mtress_component='PV2', solph_node='source')",
             "SolphLabel(location='House1', mtress_component='PV2', solph_node='connection')"),
    ...
    for month_name, filename in scenario_config["files"].items():
        ...
        # Combine both PV sources
        total_pv_kwh = (flow_data.get("Total_PV1_Production", 0) + flow_data.get("Total_PV2_Production", 0)) / 60000
        ...
        # Calculation for total monthly CO2 emissions
        ...
        monthly_data.append({
            ...
            "Total PV Production (kWh)": total_pv_kwh,
    ...
    yearly_total_pv_production = df_monthly["Total PV Production (kWh)"].sum()
    ...
    # Calculation for total yearly CO2 emissions
